    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <p>
                ...
                <input class="form-control form-control-salmon bg-dark text-white" type="text" name="car_regis_no">
            </p>
            <p>
        ...
        <?php
            if (isset($_POST['regis']))
            {
                ...
                $car_regis_no = $_POST['car_regis_no'];
                ...
                $sql = "insert user (username, email, user_type, full_name, address, tel, car_regis_no, password, status)
                value ('$user_name', '$email', '$user_type', '$full_name', '$address', '$tel', '$car_regis_no', '$password', '0')";
